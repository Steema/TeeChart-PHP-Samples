<?php
        ...
        function ConfigureChart($chart1)
        {
            ...
            $chart1->getChart()->getHeader()->setText("FastLine Chart Type 3K Points");
        ...
        $series->FillSampleValues(3000);
        $series->getMarks()->setVisible(false);
        $series->setColor(Color::FromRGB(154, 0, 176));
        
        $chart1->getChart()->getAxes()->getLeft()->setMinimumOffset(100);
        $chart1->getChart()->getAxes()->getLeft()->setMaximumOffset(100);
        $chart1->getChart()->getAxes()->getLeft()->setIncrement(25);
        $chart1->getChart()->getAxes()->getBottom()->setIncrement(500);
        ...
        $rand=rand();
        print '<font face="Verdana" size="2">FastLine Chart 3K Points<p>';        
...
<head>
  <title>FastLine Chart 3K Points</title>
